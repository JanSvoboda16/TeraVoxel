...
public:
  ...
  Server &DeleteProject(const std::string &pattern, Handler handler);
  Server &DeleteProject(const std::string &pattern, HandlerWithContentReader handler);
...
public:
  ...
  Result DeleteProject(const std::string &path);
  Result DeleteProject(const std::string &path, const Headers &headers);
  Result DeleteProject(const std::string &path, const char *body,
                size_t content_length, const std::string &content_type);
  Result DeleteProject(const std::string &path, const Headers &headers,
                const char *body, size_t content_length,
                const std::string &content_type);
  Result DeleteProject(const std::string &path, const std::string &body,
                const std::string &content_type);
  Result DeleteProject(const std::string &path, const Headers &headers,
                const std::string &body, const std::string &content_type);
...
inline Server &Server::DeleteProject(const std::string &pattern, Handler handler) {
  delete_handlers_.push_back(
      std::make_pair(std::regex(pattern), std::move(handler)));
  return *this;
}

inline Server &Server::DeleteProject(const std::string &pattern,
                              HandlerWithContentReader handler) {
...
inline Result ClientImpl::DeleteProject(const std::string &path) {
  return DeleteProject(path, Headers(), std::string(), std::string());
}
...
inline Result ClientImpl::DeleteProject(const std::string &path, const char *body,
                                 size_t content_length,
                                 const std::string &content_type) {
  return DeleteProject(path, Headers(), body, content_length, content_type);
}
...
inline Result ClientImpl::DeleteProject(const std::string &path,
                                 const std::string &body,
                                 const std::string &content_type) {
  return DeleteProject(path, Headers(), body.data(), body.size(), content_type);
}
...
inline Result Client::DeleteProject(const std::string &path) {
  return cli_->DeleteProject(path);
}
inline Result Client::DeleteProject(const std::string &path, const Headers &headers) {
  return cli_->DeleteProject(path, headers);
}
inline Result Client::DeleteProject(const std::string &path, const char *body,
                             size_t content_length,
                             const std::string &content_type) {
  return cli_->DeleteProject(path, body, content_length, content_type);
}
inline Result Client::DeleteProject(const std::string &path, const Headers &headers,
                             const char *body, size_t content_length,
                             const std::string &content_type) {
  return cli_->DeleteProject(path, headers, body, content_length, content_type);
}
inline Result Client::DeleteProject(const std::string &path, const std::string &body,
                             const std::string &content_type) {
  return cli_->DeleteProject(path, body, content_type);
}
inline Result Client::DeleteProject(const std::string &path, const Headers &headers,
                             const std::string &body,
                             const std::string &content_type) {
  return cli_->DeleteProject(path, headers, body, content_type);
}
