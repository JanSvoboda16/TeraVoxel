/*
 * Author: Jan Svoboda, Omar Cornut (Author of original file)
...
#include "TeraVoxel.Client.Gui/VolumeViewWindow.h"
#include <TeraVoxel.Client.Core/Logger.h>
#include "TeraVoxel.Client.Gui/VisualizerSettingsWindow.h"
#include <TeraVoxel.Client.Core/SettingsContext.h>
#include "TeraVoxel.Client.Gui/SettingsWindow.h"
#include <TeraVoxel.Client.VolumeRenderer/EigenBenchmark.h>
#include "TeraVoxel.Client.Gui/SceneObjectsWindow.h"
#include "TeraVoxel.Client.Gui/ToolWindow.h"
...
int main(int, char**){
	...
	::RegisterClassExW(&wc);
	HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"TeraVoxel", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, NULL, NULL, wc.hInstance, NULL);
	...
	ProjectManagementWindow projectWindow(volumeViewContext);
