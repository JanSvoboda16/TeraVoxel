...
public:
	...
	virtual std::shared_ptr<MeshNode> ExtractSurface(const std::shared_ptr<VolumeBlock<bool>> &binMap, bool interpolate, const Eigen::Vector2f &interpolationBoundary) = 0;
};
